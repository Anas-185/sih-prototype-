...
# Neo4j Connection Credentials (reads from environment variables with defaults)
...
if __name__ == "__main__":
    print("Testing Neo4j connection and queries...")
    try:
        nodes, edges = get_full_graph(limit=5)
        print(f"Success: Retrieved {len(nodes)} nodes and {len(edges)} edges without warnings.")
